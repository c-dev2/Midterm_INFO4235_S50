This project is a web application which will generate a map showing the user's current distance to the KPU Surrey campus. This app uses the Google Maps API to do this.
